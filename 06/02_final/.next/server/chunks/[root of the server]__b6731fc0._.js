...
"[project]/.next-internal/server/app/api/portfolio/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/portfolio/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ async function ensureDataDirectoryExists() {
    try {
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].mkdir(dataDir, {
            recursive: true
        }); // recursive: true prevents error if dir exists
    } catch (error) {
...
async function POST(request) {
    ...
    try {
        ...
        if (!newStock || !newStock.name || newStock.quantity == null || newStock.avgPrice == null || newStock.currentPrice == null) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Missing required stock fields (name, quantity, avgPrice, currentPrice).'
            }, {
                status: 400
            }); // Bad Request
        }
        ...
        if (existingStockIndex !== -1) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Stock '${newStock.name}' already exists in the portfolio.`
            }, {
                status: 409
            }); // Conflict
        }
        ...
        } // Bad request for JSON parse errors, 500 otherwise
        );
    }
}
async function DELETE(request) {
    ...
    try {
        ...
        if (!userData || !userData.portfolio || userData.portfolio.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Portfolio not found or empty for user ${username}.`
            }, {
                status: 404
            }); // Not Found
        }
        ...
        if (userData.portfolio.length === initialLength) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Stock '${stockNameToDelete}' not found in the portfolio.`
            }, {
                status: 404
            }); // Not Found
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: `Stock '${stockNameToDelete}' deleted successfully.`,
...
async function PUT(request) {
    ...
    try {
        ...
        if (!updatedData || updatedData.quantity == null && updatedData.avgPrice == null && updatedData.currentPrice == null) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'No update data provided (e.g., quantity, avgPrice, currentPrice).'
            }, {
                status: 400
            }); // Bad Request
        }
        ...
        if (!userData || !userData.portfolio) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Portfolio not found for user ${username}.`
            }, {
                status: 404
            }); // Not Found
        }
        ...
        if (stockIndex === -1) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Stock '${stockNameToUpdate}' not found in the portfolio.`
            }, {
                status: 404
            }); // Not Found
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: `Stock '${stockNameToUpdate}' updated successfully.`,
            updatedStock
        }); // OK
    } catch (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            status: error instanceof SyntaxError ? 400 : 500
        } // Bad request for JSON errors, 500 otherwise
        );
    }
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b6731fc0._.js.map